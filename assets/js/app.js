var config = {
  ...
  //geojson: "https://docs.zohopublic.com/file/98cksdce7bab8b50d4427b6ecf065ec386c01",
  title: "Courier Marketplace Map",
  layerName: "Drivers",
...
// Basemap Layers
//var mapboxOSM = //L.tileLayer("https://{s}.tiles.mapbox.com/v4/mapbox.streets/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoiZXZhbnNtYW5hZ2UiLCJhIjoiY2tuM3U2djl3MWw5bTJubW9hNWdrMjJ1NiJ9.L3RCTC-ZXQ4w7IztRFBOfA", {
//  maxZoom: 19,
//  subdomains: ["a", "b", "c", "d"],
...
var mapboxOSM = L.tileLayer("https://{s}.tile.openstreetmap.fr/hot/{z}/{x}/{y}.png", {
  maxZoom: 19,
  subdomains: ["a", "b", "c"],
  attribution: 'Basemap <a href="https://www.mapbox.com/about/maps/" target="_blank">© Mapbox © OpenStreetMap</a>'
});
...
$(document).ready(function () {
  $.ajax({
    type: "GET",  
    url: "https://cors.io/?https://erica.altschul.info/542Tutorial_03.xml", //"https://0489.cxtsoftware.net/CxtWebService/CxtWebServiceRest.svc/rest/process/ImportWS/PUNCHTHROUGH/4756",
    crossDomain: true,
    dataType: "xml",
    xhrFields: {
...
// $.ajax({
//    type: "GET",  
//    url: "https://04890.xdhosted.com/CxtWebService/CXTWCF.svc/v2/Drivers/30/LocationHistory",
//    crossDomain: true,
//    dataType: "json",
//    xhrFields: {
//        withCredentials: true
...
//              "accept": "application/json",
//              "Access-Control-Allow-Origin":"*", 
//              "Authorization": "Basic WERJU1BBVENILXNldmFucy0wNDg5OiAyMXB4M2tsNg=="
//          },
//    success: config2
//  });
});
